       ...
       <div class="body-div">
                 <div class="left-div">
                          <div slot="header" class="stu-list-t">
                            <span>教师列表</span>
                            <div class="stu-count">采集情况：{{collectedNumber}}/{{number}}</div>
                            <div class="stu-count">
                                <span>是否采集：</span>
...
<script>
/* eslint-disable */
import {getTeacherList, updateTeacher, faceCollected} from '@/api/baseDataApi'
    ...
    methods: {
        ...
        getCount () {
            faceCollected({
                ...
                console.log(res)
                this.collectedNumber = res.collectedNumber
                this.notCollectedNumber = res.notCollectedNumber
        ...
        dataURLtoFile(dataurl, filename) {//将base64转换为文件
         ...
         selectFile () {
            ...
            document.getElementById('teacherFile').click()
        },
        inputChange (e) {
